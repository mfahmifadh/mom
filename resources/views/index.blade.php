...
<head>
  ...
  <!-- Favicons -->
  <link href="assets/img/momLogo.png" rel="icon">
...
<body>
  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
      ...
      <h1 class="logo mr-auto"><a href="index.html">MOM</a></h1>
      ...
      <a href="{{ url('login') }}" class="get-started-btn">Masuk</a>
    ...
    <section id="trainers" class="trainers">
      <div class="container" data-aos="fade-up">
        ...
        <div class="row" data-aos="zoom-in" data-aos-delay="100">
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
            <div class="member">
              <img src="{{ url('assets/img/trainers/'.$listMentor->profile_photo_path) }}" class="img-fluid" alt="">
              <div class="member-content">
                <h4>{{$listMentor->name}}</h4>
  ...
  <footer id="footer">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 footer-newsletter">
            ...
            <p>Dapatkan info menarik MoM lewat email daftarkan segera email anda!</p>
    ...
    <div class="container d-md-flex py-4">
      ...
      <div class="mr-md-auto text-center text-md-left">
        <div class="copyright">
          &copy; Copyright <strong><span>MOM</span></strong>. All Rights Reserved
        </div>
        <div class="credits">
          ...
          Designed by <a href="https://bootstrapmade.com/">START-UP</a>
        </div>
      </div>
