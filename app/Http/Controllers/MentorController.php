...
class MentorController extends Controller
{
    ...
    public function GetCourse($id)
    {
        $course = DB::table("class")
                ...
                ->select('class.id','class_category.name','class.course_category', 'class.class_name', 'class.class_member_max',
                        'class.class_status', 'class.class_time_perday', 'class.class_permonth', 'class.class_cost')
                ->where('user_id', $id)
                ->get();
    ...
    public function EditCourse($id)
    {
        $class = DB::table("class")
                ...
                ->select('class.id','class_category.name','class.course_category', 'class.class_name', 'class.class_member_max',
                        'class.class_status', 'class.class_time_perday', 'class.class_permonth', 'class.class_cost',
                        'class.class_description', 'class.class_category_id', 'class.user_id')
                ->where('class.id', $id)
                ->get();
        $class_category = DB::table("course_class_category")->get();
